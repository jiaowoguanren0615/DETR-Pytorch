...
# 1.标签路径
labelme_path = "./save_img/"
# 原始labelme标注数据路径
saved_path = "./MyObjData/"
# 保存路径
...
for json_file_ in files:
    ...
    height, width, channels = cv2.imread('./save_img/' + json_file_ + ".jpeg").shape
...
image_files = glob("./save_img/" + "*.jpeg")
...
total_files = glob("./MyObjData/Annotations/*.xml")
